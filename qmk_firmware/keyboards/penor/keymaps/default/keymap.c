...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     */
    [_NAV] = LAYOUT(
        KC_ESC, KC_WH_U, KC_HOME, KC_UP, KC_END, KC_PGUP, _______, KC_INS, _______, _______, CK_MACRO_RECORD, CK_MACRO_DELAY,
     ...
     */
    [_MOUSE] = LAYOUT(
        _______, KC_WH_U, KC_BTN4, KC_MS_U, KC_BTN5, KC_PGUP, TG(_GAMING), KC_PSCR, KC_SCRL, KC_PAUS, CK_UNICODE_MODE, _______,
