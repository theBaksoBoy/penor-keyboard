...
* A layer that changes most of the keys to macros for common Englihs words.
* Keys for controlling the mouse. If you hold down all movement directions, after releasing one direction a short timer will begin. When the timer ends, whichever directions are still being held down will make the mouse move extremely far in those directions, basically warping the mouse to the corner or edge of the screen.
